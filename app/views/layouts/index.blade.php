...
<script type="text/javascript" src="{{ asset('packages/fancybox/fancybox/jquery.fancybox-1.3.4.pack.js') }}"></script>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <center>
                                    <iframe
                                        src="//www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2Fcich.md&amp;width=500&amp;height=290&amp;colorscheme=dark&amp;show_faces=true&amp;header=true&amp;stream=false&amp;show_border=true"
                                        scrolling="no" frameborder="0"
                                        style="border:none; overflow:hidden; width:500px; height:290px;"
...
<div class="row">
    ...
    height: 100px;
">
        <a href="http://cic.cich.md/public/"><img src="http://cic.cich.md/public/assets/images/header_logo.png"
                                                  title="CICH Logo" alt="CICH Logo" style="
    width: 500px;
"></a>
    </div>
...
">
    ...
    left: 150px;
">
        <a href="/public/ro"><img style="width:25px;"
                                  src="http://cdn1.iconfinder.com/data/icons/finalflags/48/Romania-Flag.png"
                                  title="Română"></a>
        <a href="/public/en"><img style="margin-left:5px;width:25px;"
                                  src="http://abali.ru/wp-content/uploads/2010/12/united-kingdom-flag-48x48.png"
                                  title="English"></a>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-md-offset-5">
                ...
                <a href="http://twitter.com/cichmd" target="_blank"><img class="img-responsive icon" alt="Twitter"
                                                                         onmouseover="this.src='/public/assets/images/twitter-icon1.png'"
                                                                         onmouseout="this.src='/public/assets/images/twitter-icon.png'"
                                                                         src="{{ asset('assets/images/twitter-icon.png') }}"></a>
                <a href="https://www.facebook.com/cichmd" target="_blank"><img class="img-responsive icon"
                                                                               alt="Facebook"
                                                                               onmouseover="this.src='/public/assets/images/facebook-icon1.png'"
                                                                               onmouseout="this.src='/public/assets/images/facebook-icon.png'"
                                                                               src="{{ asset('assets/images/facebook-icon.png') }}"></a>
                <a href="http://youtube.com/cichmd" target="_blank"><img class="img-responsive icon" alt="Youtube"
                                                                         onmouseover="this.src='/public/assets/images/youtube-icon1.png'"
                                                                         onmouseout="this.src='/public/assets/images/youtube-icon.png'"
                                                                         src="{{ asset('assets/images/youtube-icon.png') }}"></a>
                <a href="#"> <img class="img-responsive icon" alt="Wifi"
                                  onmouseover="this.src='/public/assets/images/wifi-icon1.png'"
                                  onmouseout="this.src='/public/assets/images/wifi-icon.png'"
                                  src="{{ asset('assets/images/wifi-icon.png') }}"></a>
...
<div class="footer">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <img src="{{ asset('assets/images/footer_logo.png') }}" alt="Colegiu de Informatica"
...
<div class="post-footer">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <p class="text-center">
                    &copy; Colegiu de Informatica din Chisinau | mun. Chisinau str. Sarmizegetusa 48 |
                    secretariat@cich.md
                </p>
            </div>
        </div>
...
<script type="text/javascript"> /*<![CDATA[*/
    ...
    function facebook() {
        if (document.getElementById('imgFb').style.right != '292px') {
            document.getElementById('imgFb').style.right = '292px';
            document.getElementById('blockFb').style.width = '292px';
        } else {
            document.getElementById('imgFb').style.right = '0px';
            document.getElementById('blockFb').style.width = '0px';
        }
...
<div id="imgFb" style="position: fixed; right: 0px; top: 70px; cursor: pointer; transition: right 1s; -webkit-transition: right 1s;">
    <img height="40px" src="http://icons.iconarchive.com/icons/danleech/simple/512/facebook-icon.png" alt="Like us on facebook" title="Like us on facebook" onclick="facebook()">
</div>
<div id="blockFb" style="position: fixed; right: 0px; top: 70px; width: 0px; transition: width 1s; -webkit-transition: width 1s; background-color: #ffffff;">
