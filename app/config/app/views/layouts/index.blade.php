...
">
    ...
    <div>
        ...
        <div class="header-menu">
        	<ul class="reset">
            	<li class="active"><a href="#"><b>Principala</b>...... тын</a></li>
                <li ><a href="#"><b>Informatii</b>...... тын</a>
